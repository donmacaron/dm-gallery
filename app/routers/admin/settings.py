"""
Settings Admin Router — Phase 4
Site-wide appearance and social settings.
"""
...
# Ordered list of settings to display in the UI
SETTINGS_GROUPS = [
    ("Site", [
    ...
    ("Social Links", [
        ("social_telegram_url",  "url", "Telegram URL"),
    ...
    ("Homepage", [
        ("homepage_album_id", "text", "Featured Album ID (empty = show all)"),
    ]),
]
