...
from app.routers.admin import reconvert     as adm_reconvert
...
app.include_router(adm_reconvert.router,  prefix="/admin")
...
async def health():
    return {"status": "ok", "app": settings.site_title, "version": "1.0.0"}
